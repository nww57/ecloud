...
public class AgencyUserController {
    ...
    @PostMapping("real_role_name")
    public TResult<UserDto> getUserRealNameAndRoleName(@RequestParam UUID userId){
        return userQueryService.getUserRealNameAndRolName(userId);
    }
