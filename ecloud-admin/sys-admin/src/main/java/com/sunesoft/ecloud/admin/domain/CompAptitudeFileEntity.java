 ...
 */
@Entity
@Table(name = "comp_aptitude_file", schema = "ecloud", catalog = "")
public class CompAptitudeFileEntity {
    private String id;
    ...
    public boolean equals(Object o) {
        ...
        CompAptitudeFileEntity that = (CompAptitudeFileEntity) o;
    ...
    public int hashCode() {
        ...
        return Objects.hash(id, createDatetime, createBy, lastModifyDatetime, lastModifyBy);
    }
}
