 ...
 * lifecycle in any case. For a Layout application, consider declaring a local
 *  org.springframework.Layout.util.IntrospectorCleanupListener in {@code Layout.xml}
...
public class CachedIntrospectionResults {
	...
	static CachedIntrospectionResults forClass(Class<?> beanClass) throws BeansException {
		...
		if (ClassUtil.isCacheSafe(beanClass, CachedIntrospectionResults.class.getClassLoader()) ||
	...
	PropertyDescriptor getPropertyDescriptor(String name) {
		...
		if (pd == null && StringUtil.hasLength(name)) {
	...
	PropertyDescriptor[] getPropertyDescriptors() {
		...
		return propertyDescriptorCache.values().toArray(pds);
	}
